...
export default function StartMyEcho() {
  ...
  const prompts = [
    {
      question: "What name should your EchoSoul remember you by?",
      field: "name"
    },
    {
      question: "What do you want your Echo to help you with right now?",
      field: "goal"
    },
    {
      question: "What's one memory or thought you'd like to save forever?",
      field: "memory"
    }
  ];

  const next = () =>
    step < prompts.length - 1 ? setStep(step + 1) : console.log("Echo initialized:", form);
